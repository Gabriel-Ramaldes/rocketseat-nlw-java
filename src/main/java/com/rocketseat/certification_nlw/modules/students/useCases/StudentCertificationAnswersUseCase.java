...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception {
        ...
        var hasCertification = this.verifyIfHasCertificationUseCase.execute(new VerifyHasCerticationDTO(dto.getEmail(), dto.getTechnology()));
        ...
        AtomicInteger correctAnswers = new AtomicInteger();
         ...
         .stream().forEach(questionAnswer -> {
            ...
            var findCorrectAlternatives = question.getAlternatives().stream().filter(alternative -> alternative.isCorrect())
            .findFirst().get();

            if(findCorrectAlternatives.getId().equals(questionAnswer.getAlternativeID())) {
         ...
         if(student.isEmpty()) {
           ...
           certificationStudentEntity.setAnswersCerticationsEntity(answersCertificationsEntities);
